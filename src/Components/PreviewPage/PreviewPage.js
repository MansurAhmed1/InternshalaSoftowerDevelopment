...
<div>
        <img
         src={event.banner}  className="w-full"
          style={{ height: "120px" }}
          alt="banner"
        />
      </div>
      <div className=" w-11/12 mx-auto pt-5 grid lg:grid-cols-2 grid-cols-1">
        <div className="">
          <p  style={{fontSize:"18px"}} className="bannerTitle  font-bold ">
           {event.eventName}
          </p>
          <p>{event.shortDescription}</p>
          <p style={{fontSize:"18px"}} className="pt-8  font-bold">What will you get?</p>
          <p class="text-justify">
         {event.description}
          </p>
        </div>
        <div className="flex pt-5 lg:pt-0 lg:justify-end ">
          <div
          ...
          >
            <div className="flex justify-center ">
              ...
              >
                ...
                <p className="text-center">{ months[event.date.split("-")[1]-1]   }</p>
              </p>
            </div>
            ...
            <p className="py-2 px-3">
              ...
              <span className="ml-2">
                {" "}
                <a className="font-bold text-blue-700" href={event.link}>Link</a>
              </span>
            </p>{" "}
            <p className="py-2 px-3">
              <FontAwesomeIcon
