    ...
    <div>
      {events.length === 0 ? (
        ...
        >
          ...
          <Link to={"/createEvent"}>
            {" "}
            <button className="border my-5 hover:bg-red-500  border-gray-500 rounded px-10 py-3 flex items-center">
              {" "}
              <img
                className="h-10 w-10 "
                ...
                alt=""
              />{" "}
              <span className="ml-2">Please Create Event </span>{" "}
            </button>
          </Link>{" "}
        </div>
      ) : (
              ...
              <div className=" w-11/12 mx-auto pt-5 grid lg:grid-cols-2 grid-cols-1">
                ...
                <div className="flex pt-5 lg:pt-0 justify-center lg:justify-end ">
                  ...
                  >
                    ...
                    <p className="py-2 px-3">
                      Duration-{event.duration} Minute
                    </p>
                  </div>
                </div>
              </div>
